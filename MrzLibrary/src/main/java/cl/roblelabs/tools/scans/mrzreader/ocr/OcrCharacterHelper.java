...
public class OcrCharacterHelper {
  ...
  public static void setBlacklist(SharedPreferences prefs, String languageCode, String blacklist) {
    if (languageCode.equals("afr")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_AFRIKAANS, blacklist).apply(); }
    else if (languageCode.equals("sqi")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ALBANIAN, blacklist).apply(); }
    else if (languageCode.equals("ara")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ARABIC, blacklist).apply(); }
    else if (languageCode.equals("aze")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_AZERI, blacklist).apply(); }
    else if (languageCode.equals("eus")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_BASQUE, blacklist).apply(); }
    else if (languageCode.equals("bel")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_BELARUSIAN, blacklist).apply(); }
    else if (languageCode.equals("ben")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_BENGALI, blacklist).apply(); }
    else if (languageCode.equals("bul")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_BULGARIAN, blacklist).apply(); }
    else if (languageCode.equals("cat")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_CATALAN, blacklist).apply(); }
    else if (languageCode.equals("chi_sim")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_CHINESE_SIMPLIFIED, blacklist).apply(); }
    else if (languageCode.equals("chi_tra")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_CHINESE_TRADITIONAL, blacklist).apply(); }
    else if (languageCode.equals("hrv")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_CROATIAN, blacklist).apply(); }
    else if (languageCode.equals("ces")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_CZECH, blacklist).apply(); }
    else if (languageCode.equals("dan")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_DANISH, blacklist).apply(); }
    else if (languageCode.equals("nld")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_DUTCH, blacklist).apply(); }
    else if (languageCode.equals("eng")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ENGLISH, blacklist).apply(); }
    else if (languageCode.equals("est")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ESTONIAN, blacklist).apply(); }
    else if (languageCode.equals("fin")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_FINNISH, blacklist).apply(); }
    else if (languageCode.equals("fra")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_FRENCH, blacklist).apply(); }
    else if (languageCode.equals("glg")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_GALICIAN, blacklist).apply(); }
    else if (languageCode.equals("deu")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_GERMAN, blacklist).apply(); }
    else if (languageCode.equals("ell")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_GREEK, blacklist).apply(); }
    else if (languageCode.equals("heb")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_HEBREW, blacklist).apply(); }
    else if (languageCode.equals("hin")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_HINDI, blacklist).apply(); }
    else if (languageCode.equals("hun")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_HUNGARIAN, blacklist).apply(); }
    else if (languageCode.equals("isl")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ICELANDIC, blacklist).apply(); }
    else if (languageCode.equals("ind")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_INDONESIAN, blacklist).apply(); }
    else if (languageCode.equals("ita")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ITALIAN, blacklist).apply(); }
    else if (languageCode.equals("jpn")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_JAPANESE, blacklist).apply(); }
    else if (languageCode.equals("kan")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_KANNADA, blacklist).apply(); }
    else if (languageCode.equals("kor")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_KOREAN, blacklist).apply(); }
    else if (languageCode.equals("lav")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_LATVIAN, blacklist).apply(); }
    else if (languageCode.equals("lit")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_LITHUANIAN, blacklist).apply(); }
    else if (languageCode.equals("mkd")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_MACEDONIAN, blacklist).apply(); }
    else if (languageCode.equals("msa")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_MALAY, blacklist).apply(); }
    else if (languageCode.equals("mal")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_MALAYALAM, blacklist).apply(); }
    else if (languageCode.equals("mlt")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_MALTESE, blacklist).apply(); }
    else if (languageCode.equals("nor")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_NORWEGIAN, blacklist).apply(); }
    else if (languageCode.equals("pol")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_POLISH, blacklist).apply(); }
    else if (languageCode.equals("por")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_PORTUGUESE, blacklist).apply(); }
    else if (languageCode.equals("ron")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_ROMANIAN, blacklist).apply(); }
    else if (languageCode.equals("rus")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_RUSSIAN, blacklist).apply(); }
    else if (languageCode.equals("srp")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SERBIAN, blacklist).apply(); }
    else if (languageCode.equals("slk")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SLOVAK, blacklist).apply(); }
    else if (languageCode.equals("slv")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SLOVENIAN, blacklist).apply(); }
    else if (languageCode.equals("spa")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SPANISH, blacklist).apply(); }
    else if (languageCode.equals("swa")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SWAHILI, blacklist).apply(); }
    else if (languageCode.equals("swe")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_SWEDISH, blacklist).apply(); }
    else if (languageCode.equals("tgl")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_TAGALOG, blacklist).apply(); }
    else if (languageCode.equals("tam")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_TAMIL, blacklist).apply(); }
    else if (languageCode.equals("tel")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_TELUGU, blacklist).apply(); }
    else if (languageCode.equals("tha")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_THAI, blacklist).apply(); }
    else if (languageCode.equals("tur")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_TURKISH, blacklist).apply(); }
    else if (languageCode.equals("ukr")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_UKRAINIAN, blacklist).apply(); }
    else if (languageCode.equals("vie")) { prefs.edit().putString(KEY_CHARACTER_BLACKLIST_VIETNAMESE, blacklist).apply(); }
    else {
      throw new IllegalArgumentException();
    }    
  }
  ...
  public static void setWhitelist(SharedPreferences prefs, String languageCode, String whitelist) {
    if (languageCode.equals("afr")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_AFRIKAANS, whitelist).apply(); }
    else if (languageCode.equals("sqi")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ALBANIAN, whitelist).apply(); }
    else if (languageCode.equals("ara")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ARABIC, whitelist).apply(); }
    else if (languageCode.equals("aze")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_AZERI, whitelist).apply(); }
    else if (languageCode.equals("eus")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_BASQUE, whitelist).apply(); }
    else if (languageCode.equals("bel")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_BELARUSIAN, whitelist).apply(); }
    else if (languageCode.equals("ben")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_BENGALI, whitelist).apply(); }
    else if (languageCode.equals("bul")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_BULGARIAN, whitelist).apply(); }
    else if (languageCode.equals("cat")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_CATALAN, whitelist).apply(); }
    else if (languageCode.equals("chi_sim")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_CHINESE_SIMPLIFIED, whitelist).apply(); }
    else if (languageCode.equals("chi_tra")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_CHINESE_TRADITIONAL, whitelist).apply(); }
    else if (languageCode.equals("hrv")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_CROATIAN, whitelist).apply(); }
    else if (languageCode.equals("ces")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_CZECH, whitelist).apply(); }
    else if (languageCode.equals("dan")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_DANISH, whitelist).apply(); }
    else if (languageCode.equals("nld")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_DUTCH, whitelist).apply(); }
    else if (languageCode.equals("eng")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ENGLISH, whitelist).apply(); }
    else if (languageCode.equals("est")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ESTONIAN, whitelist).apply(); }
    else if (languageCode.equals("fin")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_FINNISH, whitelist).apply(); }
    else if (languageCode.equals("fra")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_FRENCH, whitelist).apply(); }
    else if (languageCode.equals("glg")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_GALICIAN, whitelist).apply(); }
    else if (languageCode.equals("deu")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_GERMAN, whitelist).apply(); }
    else if (languageCode.equals("ell")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_GREEK, whitelist).apply(); }
    else if (languageCode.equals("heb")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_HEBREW, whitelist).apply(); }
    else if (languageCode.equals("hin")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_HINDI, whitelist).apply(); }
    else if (languageCode.equals("hun")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_HUNGARIAN, whitelist).apply(); }
    else if (languageCode.equals("isl")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ICELANDIC, whitelist).apply(); }
    else if (languageCode.equals("ind")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_INDONESIAN, whitelist).apply(); }
    else if (languageCode.equals("ita")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ITALIAN, whitelist).apply(); }
    else if (languageCode.equals("jpn")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_JAPANESE, whitelist).apply(); }
    else if (languageCode.equals("kan")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_KANNADA, whitelist).apply(); }
    else if (languageCode.equals("kor")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_KOREAN, whitelist).apply(); }
    else if (languageCode.equals("lav")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_LATVIAN, whitelist).apply(); }
    else if (languageCode.equals("lit")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_LITHUANIAN, whitelist).apply(); }
    else if (languageCode.equals("mkd")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_MACEDONIAN, whitelist).apply(); }
    else if (languageCode.equals("msa")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_MALAY, whitelist).apply(); }
    else if (languageCode.equals("mal")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_MALAYALAM, whitelist).apply(); }
    else if (languageCode.equals("mlt")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_MALTESE, whitelist).apply(); }
    else if (languageCode.equals("nor")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_NORWEGIAN, whitelist).apply(); }
    else if (languageCode.equals("pol")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_POLISH, whitelist).apply(); }
    else if (languageCode.equals("por")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_PORTUGUESE, whitelist).apply(); }
    else if (languageCode.equals("ron")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_ROMANIAN, whitelist).apply(); }
    else if (languageCode.equals("rus")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_RUSSIAN, whitelist).apply(); }
    else if (languageCode.equals("srp")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SERBIAN, whitelist).apply(); }
    else if (languageCode.equals("slk")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SLOVAK, whitelist).apply(); }
    else if (languageCode.equals("slv")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SLOVENIAN, whitelist).apply(); }
    else if (languageCode.equals("spa")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SPANISH, whitelist).apply(); }
    else if (languageCode.equals("swa")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SWAHILI, whitelist).apply(); }
    else if (languageCode.equals("swe")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_SWEDISH, whitelist).apply(); }
    else if (languageCode.equals("tgl")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_TAGALOG, whitelist).apply(); }
    else if (languageCode.equals("tam")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_TAMIL, whitelist).apply(); }
    else if (languageCode.equals("tel")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_TELUGU, whitelist).apply(); }
    else if (languageCode.equals("tha")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_THAI, whitelist).apply(); }
    else if (languageCode.equals("tur")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_TURKISH, whitelist).apply(); }
    else if (languageCode.equals("ukr")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_UKRAINIAN, whitelist).apply(); }
    else if (languageCode.equals("vie")) { prefs.edit().putString(KEY_CHARACTER_WHITELIST_VIETNAMESE, whitelist).apply(); }
    else {
      throw new IllegalArgumentException();
    }    
  }
