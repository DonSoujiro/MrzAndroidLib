...
package cl.roblelabs.tools.scans.mrzreader.tasks;
...
import cl.roblelabs.tools.scans.mrzreader.camara.PlanarYUVLuminanceSource;
...
public final class DecodeHandler extends Handler {
  ...
  static public void resetDecodeState() {
  ...
  private void ocrContinuousDecode(byte[] data, int width, int height) {   
    ...
    Pix thresholdedImage = Binarize.otsuAdaptiveThreshold(Convert.convertTo8(ReadFile.readBitmap(bitmap)));
