 ...
 */
package cl.roblelabs.tools.scans.mrzreader.views;
...
public final class ViewfinderView extends View {
  ...
  static public final boolean DRAW_REGION_BOXES = false;

  /** Flag to draw boxes representing the results from TessBaseAPI::GetTextlines(). */
  static  public final boolean DRAW_TEXTLINE_BOXES = true;

  /** Flag to draw boxes representing the results from TessBaseAPI::GetStrips(). */
  static public final boolean DRAW_STRIP_BOXES = false;
